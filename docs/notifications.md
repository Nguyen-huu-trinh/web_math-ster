...
5. Teacher saves a lesson resource with the send checkbox checked: one broadcast appears, opening its course/chapter.
...
- Material URL parameters are preserved; the course list opens the requested chapter and highlights the requested lesson.
